...
class BuscafolhaspSpider (scrapy.Spider):
    ...
    def start_requests (self):
        urls = ['http://search.folha.uol.com.br/search?q=michel%20temer&site=todos&sd=01%2F01%2F2018&ed=31%2F08%2F2018&periodo=personalizado&results_count=3571&search_time=0%2C217&url=http%3A%2F%2Fsearch.folha.uol.com.br%2Fsearch%3Fq%3Dmichel%2520temer%26site%3Dtodos%26sd%3D01%252F01%252F2018%26ed%3D31%252F08%252F2018%26periodo%3Dpersonalizado&sr=0']
        for url in urls:
            yield scrapy.Request(url=url, callback=self.parse)

    def parse (self, response):
        
        name_subject = 'michel_temer_01-01-2018--31-08-2018'
